...
if ~isfield(opt,'beep_time')
    beep_time=2;
else
    beep_time=getfield(opt,'beep_time');
end
...
%rightg=1, left=2, right=3 paradigm start=4, paradigm end=5
% config_io;
which('right.jpg')
%image load
img_right=imread('C:\Github\OpenBMI\BMI_modules\Paradigms\MotorImagery\Stimulus\right.jpg');
img_left=imread('C:\Github\OpenBMI\BMI_modules\Paradigms\MotorImagery\Stimulus\left.jpg');
img_down=imread('C:\Github\OpenBMI\BMI_modules\Paradigms\MotorImagery\Stimulus\down.jpg');
img_cross=imread('C:\Github\OpenBMI\BMI_modules\Paradigms\MotorImagery\Stimulus\cross.jpg');
