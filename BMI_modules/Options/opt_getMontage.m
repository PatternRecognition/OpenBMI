...
%        'PCP9h','PCP7h','PCP5h','PCP3h','PCP1h','PCP2h','PCP4h','PCP6h','PCP8h','PCP10h', ...
%        'P9','P7','P5','P3','P1','Pz','P2','P4','P6','P8','P10', ...
%        'PPO9h','PPO5h','PPO3h','PPO1h','PPO2h','PPO4h','PPO6h','PPO10h',  ...
%        'PO9','PO7','PO5','PO3','PO1','POz','PO2','PO4','PO6','PO8','PO10', ...
%        'OPO1h','OPO2h', ...
%        'O9','O1','O2','O10', ...
%        'Oz', ...
...
clab= {'Fpz', ...
       ...
       'FTT9h','FTT7h','FCC5h','FCC3h','FCC1h','FCC2h','FCC4h','FCC6h','FTT8h','FTT10h', ...
       'T9','T7','C5','C3','C1','Cz','C2','C4','C6','T8','T10', ...
       'A1','TTP7h','CCP5h','CCP3h','CCP1h','CCP2h','CCP4h','CCP6h','TTP8h','A2', ...
       'TP9','TP7','CP5','CP3','CP1','CPz','CP2','CP4','CP6','TP8','TP10', ...
...
chan_idx = find(ismember(Position.clab,SMT.chan)); % Changed by hk_kim
