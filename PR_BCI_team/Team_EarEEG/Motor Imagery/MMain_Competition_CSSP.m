...
clc
clear
OpenBMI('D:\2017_0702_KYJ\GG\Toolbox') 
...
%                                     channel_index=[31,50,68,67, 41,58,76,77];
                ...
                % Time delay
                SMT_tr.x=permute(SMT_tr.x,[1,3,2]);
                SMT_tr_d=prep_segmentation(CNT_tr, {'interval', interval-10*tau});
                SMT_tr_d.x=permute(SMT_tr_d.x,[1,3,2]);
                SMT_tr.x=[SMT_tr.x,SMT_tr_d.x];
                SMT_tr.x=permute(SMT_tr.x,[1,3,2]);
                ...
                % Time delay
                SMT_te.x=permute(SMT_te.x,[1,3,2]);
                SMT_te_d=prep_segmentation(CNT_te, {'interval', interval-10*tau});
                SMT_te_d.x=permute(SMT_te_d.x,[1,3,2]);
                SMT_te.x=[SMT_te.x,SMT_te_d.x];
                SMT_te.x=permute(SMT_te.x,[1,3,2]);
        ...
        [accsub(Subj),ttau(Subj)]=max(acctau)
