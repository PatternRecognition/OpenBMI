...
def exp(subject_id):
    ...
    #20% validation
    train_size = int(0.999 * len(splitted['session_T']))
    ...
    embedding_net = Deep4Net_origin(n_classes, n_chans, input_window_samples)
...
if __name__ == '__main__':
    ...
    for id in range(1,10):
        ...
        df_all.to_csv("bcic_dk_ds_deep4net_fc.csv",mode='w')
