...
def exp(subject_id):
    ...
    PATH = '../datasets/'
    with open(PATH + 'bcic_datasets_[0,38].pkl', 'rb') as f:
        data = pickle.load(f)
    ...
    # scheduler = lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=100, T_mult=2)
    #
    # #test lr
    # lr = []
    # for i in range(200):
...
if __name__ == '__main__':
    ...
    for id in range(0,9):
        ...
        df_all.to_csv("center_shallow_[0,38]2.csv",mode='w')
