...
from mynetworks import Deep4Net_origin, ConvClfNet, FcClfNet, EEGNet_v2
from trte import *
...
def exp(subject_id):
    ...
    for epochidx in range(1, epochs):
        print(epochidx)
        train_smooth(10,subject_id, model, device, train_loader,optimizer,scheduler,cuda, args.gpuidx)
...
if __name__ == '__main__':
    ...
    for id in range(1,10):
        ...
        df_all.to_csv("bcic_ERM_labelsmoothing_4.csv",mode='w')
        ...
        df_summary.to_csv("bcic_ERM_labelsmoothing_summary4.csv", mode='w')
