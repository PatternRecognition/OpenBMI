...
def fit(train_loader, val_loader, model, loss_fn, optimizer, scheduler,epochidx, n_epochs, cuda,gpuidx, log_interval, metrics=[],
    ...
    # Train stage
    train_loss, tri_loss, clf_loss, metrics = train_epoch(train_loader, model, loss_fn, optimizer, scheduler, cuda, gpuidx,log_interval, metrics)
...
def train_epoch(train_loader, model, loss_fn, optimizer, scheduler, cuda,gpuidx, log_interval, metrics):
    for metric in metrics:
        metric.reset()
