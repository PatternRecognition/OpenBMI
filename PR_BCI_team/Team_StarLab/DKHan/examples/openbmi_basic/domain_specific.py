...
def experiment(args):
    ...
    dataset_train = GigaDataset(x=x_data, y=y_data,transform=True, valtype=valtype, istrain=True, subj=train_subj,
                                trial=trial_train)
    dataset_test = GigaDataset(x=x_data, y=y_data,transform=True, valtype=valtype, istrain=False, subj=test_subj, trial=trial_val)
    ...
    embedding_net = nets.Deep4Net_origin(2, 62, 900,batch_norm=True)
