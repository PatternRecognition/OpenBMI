...
for sess in [1,2]:
    ...
    for sub in range(1,55):
        ...
        epochs1 = gigadata_epochs(raw1, events1, tmin=-4., tmax=4.)
        epochs2 = gigadata_epochs(raw2, events2, tmin=-4., tmax=4.)
...
with open('D:/data/midata/convert/MI_62ch_250Hz_-4to4.pkl', 'wb') as f:
