...
def experiment(args):
    ...
    triplet_dataset_train = TripletGiga5(x=x_data, y=y_subj, valtype=valtype, istrain=True, subj=train_subj,
                                         trial=trial_train)

    triplet_dataset_test = TripletGiga5(x=x_data, y=y_subj, valtype=valtype, istrain=False, subj=test_subj,
                                        trial=trial_val)
