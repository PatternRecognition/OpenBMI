addpath([BCI_DIR 'acquisition/setups/project2010_biomed02']);
fprintf('\n\nWelcome to Project Biomed 2010 - Team 02.\n\n');
...
if strcmp(VP_CODE, 'Temp');
  ...
  VP_COUNTER_FILE= [DATA_DIR 'project2010_biomed02_VP_Counter'];
...
bbci.feedback= 'ERP_MatrixSpeller';
bbci.classDef= {[31:49], [11:29];
                'target', 'nontarget'};
bbci.marker_output.marker= num2cell([31:36, 41:45, 11:16, 21:25]);
bbci.marker_output.value= [1:11, 1:11];
bbci.start_marker= [240];           %% Countdown start
bbci.quit_marker= [2 255];  %% Push button or end markers
bbci.pause_after_quit_marker= 1000;
bbci_default = bbci;

%VP_SCREEN = [0 0 1920 1200];
VP_SCREEN = [0 0 1280 1024];
fprintf('Type ''run_project2010_biomed02'' and press <RET>\n');
