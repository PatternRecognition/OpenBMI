...
addpath([BCI_DIR 'acquisition/setups/dry_wet_comparison']);
addpath([BCI_DIR 'acquisition/setups/season10']);

setup_bbci_online; %% needed for acquire_bv

fprintf('\n*********************\nWelcome to dry wet comparison \n*********************\n');
...
bvr_sendcommand('loadworkspace', 'occipital_3A');
...
fprintf('Type ''run_dry_wet_comparison'' and press <RET>\n');