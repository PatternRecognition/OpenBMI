function [sm_ss_tone, sm_db_downsampled] = generate_modulated_ASS_sound(varargin)
%
%
...
% db_max - upper limit of loudness, given in decibel relative to db_min
% db_min - lower limit of loudness, given in decibel
% fs_downsample - sampling rate for down-sampled version of the slow
% amplitude modulation
% same_sound - use the same sound for both ears - 0 or 1 (default 1) 
...
if opt.same_sound
    sm = create_slow_random_signal(T, sound_fs, modulation_cutoff_freq, 1);
    sm = repmat(sm, [2,1]);
else
