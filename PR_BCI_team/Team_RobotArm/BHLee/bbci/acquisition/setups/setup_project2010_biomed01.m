addpath([BCI_DIR 'acquisition/setups/project2010_biomed01']);
fprintf('\n\nWelcome to Project Biomed 2010 - Team 01.\n\n');
...
if strcmp(VP_CODE, 'Temp');
  ...
  VP_COUNTER_FILE= [DATA_DIR 'project2010_biomed01_VP_Counter'];
...
bbci.quit_marker= [2 4 8 247 255];  %% Push button or end markers
bbci.pause_after_quit_marker= 1000;
bbci_default = bbci;

%VP_SCREEN = [0 10 1920 1180];
VP_SCREEN = [0 0 1280 1024];
fprintf('Type ''run_project2010_biomed01'' and press <RET>\n');
