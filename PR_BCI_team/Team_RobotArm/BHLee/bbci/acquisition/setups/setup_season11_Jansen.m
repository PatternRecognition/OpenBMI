...
cfy_name= 'cls_ERD_24chan_mcc_LF_VPfb.mat';
%cfy_name= 'cls_ERD_24chan_mcc_LF_VPfb_noAdaptation.mat';
copyfile([EEG_RAW_DIR '/pretrained_ERD_classifiers/' cfy_name '*'],TODAY_DIR);

fprintf('Type ''edit run_season11_Jansen'' and press <RET>.\n');
