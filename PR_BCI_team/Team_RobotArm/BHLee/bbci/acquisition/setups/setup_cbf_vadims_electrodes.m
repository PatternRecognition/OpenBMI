...
path([BCI_DIR 'acquisition/setups/cbf_vadims_electrodes'], path);

system('c:\Vision\Recorder\Recorder.exe &'); pause(1);
bvr_sendcommand('stoprecording');

% Load Workspace into the BrainVision Recorder
bvr_sendcommand('loadworkspace', 'Mini_EEG_June_2009');
...
fprintf('Now you can start: run_cbf_vadims_electrodes\n');
