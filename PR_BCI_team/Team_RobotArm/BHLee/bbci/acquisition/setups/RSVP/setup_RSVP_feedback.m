...
fbint.geometry = int16([0  0  1920  1200]);
fbint.headline_vpos = 100;
fbint.symbol_vpos = 600;

fbint.font_size = 256;
fbint.headline_font_size = 104;
fbint.headline_target_font_size = 152;
