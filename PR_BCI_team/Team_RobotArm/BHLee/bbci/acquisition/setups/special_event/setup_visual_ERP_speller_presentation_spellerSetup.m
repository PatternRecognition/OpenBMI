...
switch speller
  ...
  case 'HexoSpeller'
    ...
    fb.circle_radius = 100;
    fb.edge_size = 2;
    fb.speller_radius = int16(250);
    fb.font_size_level1 = int16(70);
    fb.font_size_level2 = int16(130);
    fb.fixationpoint_size = 4.0;
    fb.feedbackbox_size = 200.0;
    ...
    fb.letter_stimulus_color = [0 0 0];
    fb.feedback_color = [.8, .8, .8];
    fb.fixationpoint_color = [0 0 0];

    % stimulus types:
    fb.stimulustype_color = int16(1);
    fb.stimulustype_flash = int16(1);
    fb.flash_size_factor = 1.2;
end
