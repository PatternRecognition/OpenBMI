stim= [];
stim.cue= struct('classes','speech_eyes_closed');
[stim.cue.nEvents]= deal(1);
%[stim.cue.timing]= deal([2000 3000 1000; 0 0 0]);
...
desc= stimutil_readDescription('season9_eyes_closed');
h_desc= stimutil_showDescription(desc, 'waitfor',0);

opt.filename= 'eyes_closed';
opt.msg_fin= 'Ende';
