function [seq, wav, opt]= setup_season8_artifacts_demo(varargin)
...
seq= ['P5000 f6F7P2000 ' ...
      ...
      'P2000 ' ...
      'F12P10000 F1P3000 ' ...
      'R[10] (F14P15000 F1P2000 F15P15000 F1P2000) F20P1000'];
...
desc= stimutil_readDescription('muscog_artifacts');
