...
if conditions(jj,2)== int16(0)
  pyff('setint','shape_on',0);
  pyff('setint','font_size_level2',250);   
end

if conditions(jj,1) == int16(0)
  pyff('set','letter_color',[1, 1, 1]);
end
