...
bbci.train_file= {strcat(subdir, '/PhotoBrowser_train_', modes{1},VP_CODE, '*'), ...
    strcat(subdir, '/PhotoBrowser_train_', modes{2}, VP_CODE, '*'), ...
    strcat(subdir, '/PhotoBrowser_train_', modes{3}, VP_CODE, '*'), ...
    strcat(subdir, '/PhotoBrowser_train_', modes{4}, VP_CODE, '*')};
...
bbci.classDef = {101, 1; 'Target', 'Non-target'};
% bbci.classes= 'auto';
