...
fprintf('\nWelcome to the Auditory Online System\n');
...
bbci.clab = {'*'};
bbci.classDef = {[11:18], [1:8]; 'Target', 'Non-target'};
% bbci.classes= 'auto';
...
bbci.withgraphics = 1;
disp(' ')
disp('  To run the experimnent block by block ')
disp('  edit c:\svn\bbci\acquisition/setups/spatialbci/runs/run_online_spelling.m')
