function [seq, wav, opt]= setup_season11_relax(varargin)
...
%seq= ['P2000 F21P2000 R[3] (F14P15000 F1P2000 F15A15000 F1P2000) F20P1000']; % Stupid Animation not working 
seq= ['P2000 F21P2000 R[3] (F14P15000 F1P2000 F15P15000 F1P2000) F20P1000'];
