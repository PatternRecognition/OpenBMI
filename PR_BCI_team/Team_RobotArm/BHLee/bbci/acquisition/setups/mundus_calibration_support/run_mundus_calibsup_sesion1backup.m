...
%% TEST FES
RAW_ETH = 1; 
[stim, opt] = setup_mundus_calibsup_image_arrow({'left','right','down'}, 5, 2000, 3000);
...
bbci.setup='cspauto';
bbci.subdir = 'D:\data\bbciRaw\VPm6a_10_12_07';
bbci.train_file= strcat(bbci.subdir, '/MI_FES*');
...
%--------------------------------------------------------------------------
RAW_ETH = 1;
[stim, opt] = setup_mundus_calibsup_image_arrow({'left','down'}, 40, 2000, 3000);
