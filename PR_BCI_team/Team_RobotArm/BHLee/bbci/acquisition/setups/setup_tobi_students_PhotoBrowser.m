...
bvr_sendcommand('loadworkspace', 'reducerbox_64std.rwksp'); 
...
addpath([BCI_DIR '\acquisition\setups\TOBI_students_PhotoBrowser'])
fprintf('please start PYFF')
pause;
fprintf('everything was successfully set up! \n')
fprintf('Type ''run_TOBI_students_PhotoBrowser'' and press <RET>.\n');
