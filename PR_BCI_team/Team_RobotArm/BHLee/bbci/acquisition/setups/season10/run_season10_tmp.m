...
% pause
% stim_artifactMeasurement(seq, wav, opt);
% fprintf('Instruct participant for STROOP. Press <RETURN> when ready to train classifier.\n');
% pause
% close all
% 
% 
...
for ri= 1:3,
  ...
  switch(ri),
   case 1, 
    fprintf('When feedback has finished, participant performs ZHAND. After that press <RETURN>.\n');
    pause; fprintf('Thank you for letting me know ...\n');
