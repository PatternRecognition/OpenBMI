function [seq, wav, opt]= setup_smr_neurofeedback_relax_long(varargin)
...
%seq= ['P1000 F21P1000 R[15] (C5000 F15A15000 F1P1000) F20P1000'];
seq= ['P1000 F21P1000 R[1] (C5000 F15A300000 F1P1000) F20P1000'];
...
opt.filename= 'resting';
opt.multicross= 0;
opt.handle_cross= 0;

desc= stimutil_readDescription('SMR_dependant_online_relax');
