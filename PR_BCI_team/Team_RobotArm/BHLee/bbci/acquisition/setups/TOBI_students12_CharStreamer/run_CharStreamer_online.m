...
bbci.calibrate.file = strcat(['condi' num2str(cond) '_' VP_CODE '*'])
bbci.calibrate.save.file= strcat(['bbci_condi_' num2str(cond) 'classifier_CharStreamer_', VP_CODE]);
...
bbci.quit_condition.marker = 211;
bbci_save(bbci, data);
