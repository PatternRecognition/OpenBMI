...
addpath([BCI_DIR 'acquisition/setups/TOBI_CharStreamer_online12'])
...
bbci_default.source.record_basename= 'CharStreamer_FreeSpelling_mode';
...
BC.read_param= {'fs',50}; 
BC.marker_fcn= [];
BC.marker_param= {{[101:109], [1:9]; 'target', 'nontarget'} {[110:119], [10:19]; 'target', 'nontarget'} {[119:130], [19:30]; 'target', 'nontarget'}} %{{[101:130], [1:30]; 'target', 'nontarget'}};
BC.save.file= 'bbci_classifier_CharStreamer';
BC.fcn= @bbci_calibrate_ERP_CharStreamer_3cls;
BC.settings= strukt(...
                  'disp_ival', [-500 1600], ...
                  'ref_ival', [], ... [-500 -350]
                  'band', band, ...
