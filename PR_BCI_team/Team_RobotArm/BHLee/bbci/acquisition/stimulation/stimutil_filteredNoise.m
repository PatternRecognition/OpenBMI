function noise = stimutil_filteredNoise(sample_freq, duration, filter_type, lowerBound, upperBound, rampon, rampoff)
%stim_filteredNoise
%
%Synopsis:
...
lp = floor(lf * d); % ls point in frequency domain    
hp = ceil(hf * d); % hf point in frequency domain
