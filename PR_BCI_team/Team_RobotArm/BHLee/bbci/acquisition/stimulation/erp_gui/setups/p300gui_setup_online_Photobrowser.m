...
bbci.allowed_files = {'PhotoBrowser_train_full', 'PhotoBrowser_train_mask', 'PhotoBrowser_train_flash'};
send_xmlcmd_udp('init', '127.0.0.1',bbci.fb_port);

if exist('original_fs', 'var'),
    bbci.filt.b = [];bbci.filt.a = [];
    Wps= [10 13]/original_fs*2;
