...
#class training_ssvep(MainloopFeedback):
class training_ssvep(MainloopFeedback):
    ...
    def on_init(self):
        ...
        self.startingFrequency = 3       
        self.endingFrequency = 30
    ...
    def pre_mainloop(self):
        ...
        for k in range (0, self.numberOfLoops):
            ...
            training_ssvep.START_TRIAL_ANIMATION = 1
            ...
            for i in range(0, len(self.flicker_rate)):
                ...
                if i < len(self.flicker_rate) - 1:
                    self.shortBreak() 
                training_ssvep.START_TRIAL_ANIMATION = training_ssvep.START_TRIAL_ANIMATION + 1 
                print training_ssvep.START_TRIAL_ANIMATION
        self.send_parallel(training_ssvep.END_EXP)
    ...
    def init_run(self):
        ...
        self.send_parallel(training_ssvep.START_TRIAL_ANIMATION)
        self.p.go()
...
#switches if all the letters or only random ones will be displayed 
    ...
    #initiate the screen
    def initScreen(self):
        self.send_parallel(training_ssvep.START_EXP)  #not sure if that's the right place for it..
...
# ------------------------------------------------------------  
    ...
    def countdown(self):
        ...
        self.send_parallel(training_ssvep.COUNTDOWN_START)
        f.go()
    ...
    def shortBreak(self):  
        self.send_parallel(training_ssvep.SHORTPAUSE_START)      
        self.h.go()
        self.h.between_presentations()
        #self.send_parallel(training_ssvep.SHORTPAUSE_END)
