...
#       13. In self.part=3, it seems to take only the first lecture and in
#            self.part=6, it seems to consider second object in the lecture list
...
#                print 'filename'
#                print filename
#                print 'self.lection_path'
#                print self.lection_path
#                print 'final path'
#                print str(''.join([self.lection_path, filename]))
#                print '*******************************'
#                print 'Dictionary: '+str(len(final_dict))
#                print final_dict
...
#        else:
#            os.environ['SDL_VIDEO_WINDOW_POS'] = str(-1920)+","+str(0)
        if self.fullscreen:
