...
class training_ssvep2(MainloopFeedback):
    ...
    def on_init(self):
        ...
        self.countDownTime = 1       #one countdown / sec, 
                                     #at the moment, more than 5 will not work   
        self.timeForOneFruequency = 2       #time of trial is given in seconds
        #----------------------------------        
        ...
        #optionally by user
        self.bgColor = (1.0,1.0,1.0,1.0)   #background color
