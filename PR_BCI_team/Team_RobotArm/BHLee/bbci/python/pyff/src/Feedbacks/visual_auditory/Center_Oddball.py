'''Feedbacks.Visual_auditory.VA_single_level
...
'''
from CenterOddballBase import CenterOddballBase, animate_sinusoid, animate
...
class Center_Oddball(CenterOddballBase):
    '''
    classdocs
    '''
...
#        self.loadAuditoryStimuli(sounds)
        ...
        #self.desired_phrase = "123456"
        
        self.letter_set = []
        self.stimuli_colors = []
        for i in range(self._nr_elements):
#            self.Oddshape_set.append(self.Oddshape_set[i])
            ...
            def update(t):
                ...
                for i in xrange(self._nr_elements):
                    ...
                    color = (self.level_2_letter_colors and 
                            ...
                            self.letter_color)
                    text = (self.Oddshape_set[self._classified_element])
