...
%      send_xml_udp('fc-signal', 's:TODAY_DIR',TODAY_DIR, 's:VP_CODE',VP_CODE);
    elseif strcmp(general_port_fields.feedback_receiver, 'tobi_c'),
        send_tobi_c_udp('init', bbci.fb_machine, bbci.fb_port); % initialize standard classifier
    else
