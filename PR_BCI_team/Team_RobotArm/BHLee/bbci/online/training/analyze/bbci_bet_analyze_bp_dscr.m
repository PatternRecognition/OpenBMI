%BBCI_BET_ANALYZE_BP_DSCR ANALYZES THE DATA PROVIDED BY
...
%FEATURES FOR BBCI_BET_FINISH_BP_DSCR. 
...
%            bbci_bet_finish_bereitschaftspotential
%
% dornheg, kraulem 07/05


% Everything that should be carried on to 
% bbci_bet_finish_bereitschaftspotential must go
...
if bbci.withgraphics
  ...
  epo_rsq= proc_r_square(proc_selectClasses(epo,bbci.classes));
