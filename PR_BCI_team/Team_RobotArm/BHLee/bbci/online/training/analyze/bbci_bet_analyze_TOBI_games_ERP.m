...
opt.selectival = select_time_intervals(proc_selectIval(epo_r, [0 opt.ival(2)]), 'nIvals',2, 'visualize', 1, 'sort', 1, 'visu_scalps', 0, 'sign', 1);
opt.selectival = [opt.selectival; select_time_intervals(proc_selectIval(epo_r, [0 opt.ival(2)]), 'nIvals',1, 'visualize', 1, 'sort', 1, 'visu_scalps', 0, 'sign', -1)];

opt.selectival =[160 210; 210 250; 260 300; 380 440];
