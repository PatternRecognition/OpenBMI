...
opt.selectival = [200 260; 380 560]%; 570 720]%; 750 800]%; 650 690]%; 610 710]%; 600 790];
%opt.selectival = [200 360; 480 700]

if (exist('OFFLINE_ANALYSIS'))
  if OFFLINE_ANALYSIS == 1
    opt.selectival = sbjData.selectival;
    warning('intervals are taken from the sbj-questionaire!')
  end
end
