function [H, cfd]= feedback_cursor_arrow_blind_init(fig, opt);
...
H.points= text(-0.5, 1 + cfd.target_width/2, 'getroffen: 0');
H.points(2)= text(0.5, 1 + cfd.target_width/2, 'daneben: 0');
set(H.points, 'VerticalAli','middle', ...
              'HorizontalAli','center', ...
              'FontUnits','normalized', ...
              opt.points_spec{:}, fast_text{:});
H.rejected_counter= text(0, -1 - cfd.target_width/2, 'verworfen: 0');
