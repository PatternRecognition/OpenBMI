function [H, cfd]= feedback_cursor_1d_pro_init(fig, opt);
...
set(H.points, 'VerticalAli','top', ...
              'HorizontalAli','center', ...
              'FontUnits','normalized', ...
              opt.points_spec{:}, fast_text{:});
H.rejected_counter= text(0, -0.99, 'REJ: 0');
set(H.rejected_counter, 'VerticalAli','bottom', ...
                  'HorizontalAli','center', ...
                  'FontUnits','normalized', ...
                  opt.points_spec{:}, fast_text{:});
