function [handle,target_rect] = feedback_2d_drive_init(fig,fb_opt);
...
arrow = fill([-1 0.5 0.5 1 0.5 0.5 -1 -1]*fb_opt.marker_size,[-0.1,-0.1,-0.5,0,0.5,0.1,0.1,-0.1]*fb_opt.marker_size,fb_opt.marker_nonactive);
set(arrow,'EdgeColor','none','EraseMode','xor');

if fb_opt.next_target==0
  set(hreg2,'Visible','off');
end

handle = [arrow,pat, cou, ht,fig,gcf,hreg,hreg2];
