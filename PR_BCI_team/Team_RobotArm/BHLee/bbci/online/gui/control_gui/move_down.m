function move_down(fig,typ,str);
% MOVE_DOWN ONLY FOR INTERN USE OF MATLAB_CONTROL_GUI
%
% moves the element in the gui one step down
%
% usage:
%    move_up(fig,typ,str);
% 
...
%    str     the fieldname to move down
%
% Guido Dornhege
% $Id: move_down.m,v 1.1 2006/04/27 14:21:11 neuro_cvs Exp $
...
if ind==length(setu.fields)
  perm = [length(setu.fields),1:length(setu.fields)-1];
else
