function send_xmlcmd_udp(varargin)
...
if nargin==3 & isequal(varargin{1},'init'),
  ...
  %FIXME: ? should be in the path of MATLAB. If trying to export, may cause
  %problems.
...
%             xml_cmd = strcat(xml_cmd, expand_matrix(var_value, fmt, var_name));
      else
