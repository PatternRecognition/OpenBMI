function mrk = mrkdef_imag_fb02(Mrk,file,opt);
%MRKDEF_IMAG_FB02 - prepare markers for extract marker information from visual 1D fixed duration feedback (feedback_cursor_1d_pro)
%
%Synopsis:
% MRK= mrkdef_imag_fb02(MRK,FILE,OPT)
%
%Arguments:
...
opt.cursor_on = 0;
opt.adaptation = 1;
opt.markertypes = [1,2,11,12,21,22,25, 60,70,71, 210,211,213]
