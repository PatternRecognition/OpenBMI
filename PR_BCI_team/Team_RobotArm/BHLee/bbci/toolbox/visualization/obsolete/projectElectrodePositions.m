function mnt= projectElectrodePositions(clab, varargin)
%mnt= projectElectrodePositions(clab, <<posSystem>, displayMontage>)
%mnt= projectElectrodePositions(clab, alpha, beta, <displayMontage>)
%mnt= projectElectrodePositions(clab, x, y, z, <displayMontage>)
%
% IN   clab  
...
%
% SEE  setDisplayMontage, calc_ext_10_10_pos, setElectrodeMontage

% kraulem 08.09.2003

bbci_obsolete(mfilename, 'getElectrodePositions');
