...
% CLAB= getClabForLaplacian(DAT, TBF, <OPT>)
%
%Arguments:
% DAT: Data structure of continuous or epoched data, or directly the full
% channel set from which the clabs for laplacian should be extracted
% TBF: Channels that should be filtered by proc_laplacian
