...
video= set_defaults([], ...
                    ...
                    'duration', 60, ...
                    'save', 1, ...
                    'save_dir', [DATA_DIR 'eegVideo/tmp2/'], ...
                    'save_name', 'csp_animation_reverted_%s.avi', ...
...
h_csp1_scalp= scalpPlot(mnt, w(:,2), opt_scalp);  %% modified! was: w(:,1)
...
h_csp2_scalp= scalpPlot(mnt, w(:,1), opt_scalp); %% modified! was: w(:,2)
