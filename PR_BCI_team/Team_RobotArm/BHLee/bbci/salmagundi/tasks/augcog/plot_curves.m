...
switch ta
 case 1
  ...
  saveFigure(sprintf('%straces%s_2_%i%i%i%i%i%i_calc',di,strii,ye,mo,da,ho,mi,se),[30 10]);
 case 2
  addTitle(sprintf('%i/%i/%i, %i:%i:%i: %s',ye,mo,da,ho,mi,se,'audio'));
  saveFigure(sprintf('%straces%s_2_%i%i%i%i%i%i_audio',di,strii,ye,mo,da,ho,mi,se),[30 10]);
end
