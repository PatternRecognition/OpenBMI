opt_fig= strukt('folder', [TEX_DIR 'presentation/bci_competition_iv/berlin/pics/'], ...
                'format', 'pdf');
...
[mrk, rClab]= reject_varEventsAndChannels(ct, mrk, ival_spec, ...
                                          ...
                                          reject_opts{:});
clear ct
printFigure('artifact_rejection', [19 12], opt_fig);
...
printFigure('spec_baseline', [19 12], opt_fig);
...
H= scalpEvolutionPlusChannel(spec_baseline, mnt_red, clab, band_list, ...
                             ...
                             'globalCLim',0, ...
                             'legend_pos',1);
printFigure('spec_baseline_topo', [20 4+6], opt_fig);
...
grid_addBars(proc_rectifyChannels(spec_r), 'h_scale',H.scale, ...
             ...
             'cLim', 'sym', ...
             'box','on');
printFigure('spec', [19 12], opt_fig);
...
grid_addBars(proc_rectifyChannels(spec_lap_r), 'h_scale',H.scale, ...
             ...
             'cLim', 'sym', ...
             'box','on');
printFigure('spec_lap', [19 12], opt_fig);
...
grid_addBars(proc_rectifyChannels(spec_r), ...
             ...
             'cLim', '0tomax', ...
             'vpos',1);
printFigure('spec_topo', [20 4+5.8*size(spec.y,1)], opt_fig);
...
shiftAxesUp; drawnow;
printFigure('spec_topo_r', [20 6], opt_fig);
...
grid_addBars(proc_rectifyChannels(erd_lap_r), 'h_scale',H.scale, ...
             ...
             'cLim', 'sym', ...
             'box','on');
printFigure('erd_lap', [19 12], opt_fig);

%grid_plot(erd_baseline, mnt, opt_grid, 'colorOrder',0.3*[1 1 1], ...
%          'scalePolicy', yLim);
%grid_markIval(ival_spec);
%printFigure('erd_baseline', [19 12], opt_fig);
...
grid_addBars(proc_rectifyChannels(erd_r), ...
             ...
             'cLim', '0tomax', ...
             'vpos',1);
printFigure('erd_topo', [20 4+5.8*size(erd.y,1)], opt_fig);
...
shiftAxesUp; drawnow;
printFigure('erd_topo_r', [20 6], opt_fig);
