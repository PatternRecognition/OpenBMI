train_file= 'Gabriel_02_09_19/selfpaced1_5sGabriel';
train_frac= 1;
test_file= 'Gabriel_02_09_19/externalpaced_fbGabriel';
%test_file= 'Gabriel_02_09_19/selfpaced_fbGabriel5';
...
dtct= [];
dtct.ival= [-1280 0];
dtct.motoJits= [-60, -110, -160];
dtct.nomotoJits= [-650, -700, -750];
dtct.shift= 0;
dtct.chans= {'FC#', 'C#', 'CP#', 'P#'};
dtct.proc= ['fv= proc_filtBruteFFT(epo, [0.8 3], 128, 200); ' ...
...
dscr.chans= {'FC#', 'C#', 'CP#', 'P#'};
dscr.proc= ['fv= proc_filtBruteFFT(epo, [0.8 3], 128, 150); ' ...
