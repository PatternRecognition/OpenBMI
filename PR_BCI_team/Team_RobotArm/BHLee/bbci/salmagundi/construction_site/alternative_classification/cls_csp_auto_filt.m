...
for vp= 1:length(subdir_list),
  ...
  if strcmp(sbj, 'VPco'),
    [cnt,mrk,mnt]= eegfile_loadMatlab([sub_dir 'real' sbj '_cut50']);
  else
    [cnt,mrk,mnt]= eegfile_loadMatlab([sub_dir 'imag_lett' sbj '_cut50']);
  end
...
save([res_dir 'csp_auto_filt'], 'perf', 'memo', 'subdir_list');
