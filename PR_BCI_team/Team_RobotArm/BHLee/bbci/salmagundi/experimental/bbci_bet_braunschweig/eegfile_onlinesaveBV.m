function eegfile_onlinesaveBV(mode,varargin)
% eegfile_onlinesaveBV(mode,<dat,mrkPos,mrkToe>)
% 
...
switch mode
 case 'init'
  ...
  fprintf(fid_hdr, ['NumberOfChannels=%d' 13 10], nChans);
  ...
  fprintf(fid_hdr, ['BinaryFormat=IEEE_FLOAT_32' 13 10]);
