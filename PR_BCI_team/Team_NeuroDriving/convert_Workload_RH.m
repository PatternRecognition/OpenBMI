...
subjectList= {'KTKIM_20180420_workload','DJLEE_20180421_workload'};
...
file_basic = 'D:\ICMI\Data\Workload\';
saveFile = 'D:\ICMI\Data\Workload\MATLAB';
...
for s = 1:length(subjectList)
    ...
    mrk= marker_Workload_Define(mrk_orig);
