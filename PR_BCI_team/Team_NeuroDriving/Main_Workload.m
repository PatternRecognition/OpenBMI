...
load('BTB.mat')
global BTB
BTB.MatDir='D:\ICMI\Data\Workload\';
subjectList = {'HSRYU_20180406_workload','JHHWANG_20180407_workload'};
saveFile = 'D:\ICMI\Figure\';
file = 'D:\ICMI\Data\Workload\MATLAB';
...
for s = 1 : length(subjectList)
    ...
    epoch = segmentationWorkload_R(cnt, mrk);
    ...
    Results_Workload(s,1:4) = [accuracy_PSD,AUC_PSD,accuracy_RPL,AUC_RPL]
end